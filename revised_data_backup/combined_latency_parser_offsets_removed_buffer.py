...
for f in range(len(server_files_50)):
  ...
  if (s == 0):
    plt.savefig('50ms-relative-offsets-combined.png')
  elif (s == 1):
    plt.savefig('100ms-relative-offsets-combined.png')
  elif (s == 2):
    plt.savefig('150ms-relative-offsets-combined.png')
  ...
  if (s == 0):
    ...
    plt.savefig('100ms-offsets-combined.png')
  elif (s == 2):
    plt.savefig('150ms-offsets-combined.png')
  ...
  #plt.savefig('app-%s.png' % filename[-1])
    if (s == 0):
    plt.savefig('50ms-app-latencies-combined.png')
  elif (s == 1):
    plt.savefig('100ms-app-latencies-combined.png')
  elif (s == 2):
    plt.savefig('150ms-app-latencies-combined.png')
  ...
  if (s == 0):
    plt.savefig('50ms-stack-latencies-combined.png')
  elif (s == 1):
    plt.savefig('100ms-stack-latencies-combined.png')
  elif (s == 2):
    plt.savefig('150ms-stack-latencies-combined.png')
