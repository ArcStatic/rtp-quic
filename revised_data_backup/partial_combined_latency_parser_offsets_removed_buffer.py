...
for f in range(len(server_files_50)):
  ...
  for a in range(len(server_files)):
    ...
    if (a == 0):
      lines.append(plt.plot(x, y, 'ro', label = "0% loss")
    elif (a == 1):
      lines.append(plt.plot(x, y, 'ro', label = "0.01% loss")
    elif (a == 2):
      lines.append(plt.plot(x, y, 'ro', label = "0.1% loss")
    elif (a == 3):
      lines.append(plt.plot(x, y, 'ro', label = "1% loss")
    elif (a == len(server_files)-1):
      lines.append(plt.plot(x, y, 'ro', label = "3% loss"))
