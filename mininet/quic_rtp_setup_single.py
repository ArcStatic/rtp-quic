...
def quic_exchange():
    ...
    #0% loss, partial
    #################################
    appServer.cmd('./ngtcp2/examples/server -b 10 -l 1000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2/test-ca/rsa/ca.key ngtcp2/test-ca/rsa/ca.cert > ngtcp2/datasets/PARTIAL_3B_0L_18000F_2000D_60R_server.txt &')
    ...
    #0% loss, reliable
    #################################
    appServer.cmd('./ngtcp2-reliable/examples/server -b 10 -l 1000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2-reliable/test-ca/rsa/ca.key ngtcp2-reliable/test-ca/rsa/ca.cert > ngtcp2/datasets/RELIABLE_3B_0L_18000F_2000D_60R_server.txt &')
