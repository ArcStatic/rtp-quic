...
def quic_exchange():
    ...
    #0.001% loss, partial
    #################################
    appServer.cmd('./ngtcp2/examples/server -b 3 -t 0.00001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2/test-ca/rsa/ca.key ngtcp2/test-ca/rsa/ca.cert > ngtcp2/datasets/PARTIAL_3B_00001L_18000F_2000D_60R_server.txt &')
    
    appClient.cmd('./ngtcp2/examples/client -b 3 -e -a 3000 -q ', appServer.IP(), ' 5004 > ngtcp2/datasets/PARTIAL_3B_00001L_18000F_2000D_60R_client.txt')
    ...
    #0.01% loss, partial
    #################################
    appServer.cmd('./ngtcp2/examples/server -b 3 -t 0.0001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2/test-ca/rsa/ca.key ngtcp2/test-ca/rsa/ca.cert > ngtcp2/datasets/PARTIAL_3B_0001L_18000F_2000D_60R_server.txt &')
    
    appClient.cmd('./ngtcp2/examples/client -b 3 -e -a 3000 -q ', appServer.IP(), ' 5004 > ngtcp2/datasets/PARTIAL_3B_0001L_18000F_2000D_60R_client.txt')
    ...
    #0.1% loss, partial
    #################################
    appServer.cmd('./ngtcp2/examples/server -b 3 -t 0.001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2/test-ca/rsa/ca.key ngtcp2/test-ca/rsa/ca.cert > ngtcp2/datasets/PARTIAL_3B_001L_18000F_2000D_60R_server.txt &')
    ...
    #0% loss, reliable
    #################################
    appServer.cmd('./ngtcp2-reliable/examples/server -b 3 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2-reliable/test-ca/rsa/ca.key ngtcp2-reliable/test-ca/rsa/ca.cert > ngtcp2/datasets/RELIABLE_3B_0L_18000F_2000D_60R_server.txt &')
    ...
    #0.001% loss, reliable
    #################################
    appServer.cmd('./ngtcp2-reliable/examples/server -b 3 -t 0.00001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2-reliable/test-ca/rsa/ca.key ngtcp2-reliable/test-ca/rsa/ca.cert > ngtcp2/datasets/RELIABLE_3B_00001L_18000F_2000D_60R_server.txt &')
    
    appClient.cmd('./ngtcp2-reliable/examples/client -b 3 -e -a 3000 -q ', appServer.IP(), ' 5004 > ngtcp2/datasets/RELIABLE_3B_00001L_18000F_2000D_60R_client.txt')
    ...
    #0.01% loss, reliable
    #################################
    appServer.cmd('./ngtcp2-reliable/examples/server -b 3 -t 0.0001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2-reliable/test-ca/rsa/ca.key ngtcp2-reliable/test-ca/rsa/ca.cert > ngtcp2/datasets/RELIABLE_3B_0001L_18000F_2000D_60R_server.txt &')
    
    appClient.cmd('./ngtcp2-reliable/examples/client -b 3 -e -a 3000 -q ', appServer.IP(), ' 5004 > ngtcp2/datasets/RELIABLE_3B_0001L_18000F_2000D_60R_client.txt')
    ...
    #0.1% loss, reliable
    #################################
    appServer.cmd('./ngtcp2-reliable/examples/server -b 3 -t 0.001 -l 18000 -i 3000 -q -f 60 ', appServer.IP(), ' 5004 ngtcp2-reliable/test-ca/rsa/ca.key ngtcp2-reliable/test-ca/rsa/ca.cert > ngtcp2/datasets/RELIABLE_3B_001L_18000F_2000D_60R_server.txt &')
