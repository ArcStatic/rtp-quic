...
client_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_3L_18000F_2000D_60R_client.txt"]


server_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/RELIABLE_3B_3L_18000F_2000D_60R_server.txt"]

client_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_3L_18000F_2000D_60R_client.txt"]


server_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/RELIABLE_3B_3L_18000F_2000D_60R_server.txt"]


client_files_150 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_3L_18000F_2000D_60R_client.txt"]


server_files_150 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/RELIABLE_3B_3L_18000F_2000D_60R_server.txt"]
...
#for s in range(1,3):
  ...
  #for f in range(2,3):
    ...
    print("latency: %d, file index: %d" % (latency, f))
    first_ts = 0
    ...
    for i in range(len(end_app_data)):
      if (("Final" not in end_app_data[i]) and ("Received" in end_app_data[i]) and ("length" not in end_app_data[i])):
        ...
        if (latency == 100):
          ...
          playback_times_actual.append(int(playback_item[0][21:]) - 24000)
        else:
    ...
    for i in range(len(app_seqnums)):
      ...
      if ((end_stack_times.get(stack_seqnums[i]) != None) and (end_app_times.get(app_seqnums[i]) != None)):
        ...
        if(i == 0):
          ...
          if ((fragment != 0) and (((playback_times_rtp_ts[i] - 3000) % 30000 == 0))):
            ...
            if (playback_diff > playback_diff_prev):
              ...
              played_time = (played_times_ns[i-1] + ((((playback_diff)/3000) * diff_per_frame_ns) + (diff_per_frame_ns * frame_gap)))
            else:
        ...
        '''
        if (playback_diff > playback_diff_prev):
          print("playback_offsets array at %d: %f" % (i, playback_offsets_array[i]))
          print("%f - %f = %f" % (played_times[i], sent_times[i], played_times[i] - sent_times[i]))
          print("pb_delay_counter: %d" % (pb_delay_counter))
        '''
        ...
        playback_offsets_array.append(pb_offset_seconds)
  ...
  for a in range(len(server_files)-1, -1, -1):
    ...
    if (a == 0):
      ...
      plt.setp(lines[2], markerfacecolor='g')
    elif (a == 2):
      lines.append(plt.step(x, y, label = "0.1% loss"))
      plt.setp(lines[1], markerfacecolor='b')
    elif (a == 3):
  ...
  if (s == 0):
    plt.savefig('50ms-relative-offsets-combined-reliable.png')
  elif (s == 1):
    plt.savefig('100ms-relative-offsets-combined-reliable.png')
  elif (s == 2):
    plt.savefig('150ms-relative-offsets-combined-reliable.png')
  ...
  if (s == 0):
    plt.savefig('50ms-offsets-combined-reliable.png')
  elif (s == 1):
    plt.savefig('100ms-offsets-combined-reliable.png')
  elif (s == 2):
    plt.savefig('150ms-offsets-combined-reliable.png')
