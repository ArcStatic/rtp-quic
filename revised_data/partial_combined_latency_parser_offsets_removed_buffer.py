...
client_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_3L_18000F_2000D_60R_client.txt"]


server_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/50ms/PARTIAL_3B_3L_18000F_2000D_60R_server.txt"]

client_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_3L_18000F_2000D_60R_client.txt"]


server_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/100ms/PARTIAL_3B_3L_18000F_2000D_60R_server.txt"]


client_files_150 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_0L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_001L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_01L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_1L_18000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_3L_18000F_2000D_60R_client.txt"]


server_files_150 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_0L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_001L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_01L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_1L_18000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/150ms/PARTIAL_3B_3L_18000F_2000D_60R_server.txt"]
...
time_axis_data_stack_array_collected = []
sent_times_collected = []
stack_latencies_collected = []
app_latencies_collected = []
...
for s in range(3):
  for f in range(len(server_files_50)):
    if (s == 0):
      latency = 50
      server_files = server_files_50
      client_files = client_files_50
    elif (s == 1):
      liatency = 100
      server_files = server_files_100
      client_files = client_files_100
    else:
      latency = 150
      server_files = server_files_150
      client_files = client_files_150
  ...
  #'''
    ...
    time_axis_data_stack_array_collected.append(time_axis_data_stack_array)
    sent_times_collected.append(sent_times)
    stack_latencies_collected.append(stack_latencies)
    app_latencies_collected.append(app_latencies)
  ...
  plt.xlabel("Intended playback time (s)")

  #lines = plt.step(x, y, label='Actual time each packet is played when reaching application')
  lines = []
  
  #for a in range(len(server_files)):
  for a in range(len(server_files)-1, -1, -1):
    x = sent_times_collected[a]
    y = played_times_collected[a]
    if (a == 0):
      lines.append(plt.step(x, y, label = "0% loss"))
      plt.setp(lines[3], markerfacecolor='r')
    elif (a == 1):
      lines.append(plt.step(x, y, label = "0.01% loss"))
      plt.setp(lines[2], markerfacecolor='b')
    elif (a == 2):
      lines.append(plt.step(x, y, label = "0.1% loss"))
      plt.setp(lines[1], markerfacecolor='g')
    elif (a == 3):
      lines.append(plt.step(x, y, label = "1% loss"))
      plt.setp(lines[0], markerfacecolor='k')
  ...
  #plt.savefig('50ms-offsets-combined.png')
  if (s == 0):
    plt.savefig('50ms-relative-offsets-combined-PARTIAL.png')
  elif (s == 1):
    plt.savefig('100ms-relative-offsets-combined-PARTIAL.png')
  elif (s == 2):
    plt.savefig('150ms-relative-offsets-combined-PARTIAL.png')
  ...
  colours = ['r', 'b', 'g', 'k']
  #for a in range(len(server_files)):
  for a in range(len(server_files) - 1):
  ...
  if (s == 0):
    plt.savefig('50ms-offsets-combined-PARTIAL.png')
  elif (s == 1):
    plt.savefig('100ms-offsets-combined-PARTIAL.png')
  elif (s == 2):
    plt.savefig('150ms-offsets-combined-PARTIAL.png')
  ...
  for a in range(len(server_files)-1, -1, -1):
    x = time_axis_data_app_array_collected[a]
    y = app_latencies_collected[a]
    if (a == 0):
      lines.append(plt.plot(x, y, 'o', label = "0% loss"))
      plt.setp(lines[3], markerfacecolor='r')
    elif (a == 1):
      lines.append(plt.plot(x, y, 'o', label = "0.01% loss"))
      plt.setp(lines[2], markerfacecolor='b')
    elif (a == 2):
      lines.append(plt.plot(x, y, 'o', label = "0.1% loss"))
      plt.setp(lines[1], markerfacecolor='g')
    elif (a == 3):
      lines.append(plt.plot(x, y, 'o', label = "1% loss"))
      plt.setp(lines[0], markerfacecolor='k')
    #elif (a == len(server_files)-1):
      #lines.append(plt.plot(x, y, 'o', label = "3% loss"))
  plt.setp(lines, markersize=1.0)
  ...
  if (s == 0):
    ...
    plt.savefig('50ms-app-latencies-combined-PARTIAL.png')
  elif (s == 1):
    plt.axis([0, 300, 100, 150])
    plt.savefig('100ms-app-latencies-combined-PARTIAL.png')
  elif (s == 2):
    plt.axis([0, 300, 150, 225])
    plt.savefig('150ms-app-latencies-combined-PARTIAL.png')
  ...
  #for a in range(len(server_files)):
  for a in range(len(server_files)-1, -1, -1):
    x = time_axis_data_stack_array_collected[a]
    y = stack_latencies_collected[a]
    if (a == 0):
      lines.append(plt.plot(x, y, 'o', label = "0% loss"))
      plt.setp(lines[3], markerfacecolor='r')
    elif (a == 1):
  ...
  if (s == 0):
    plt.axis([0, 300, 50, 75]) 
    plt.savefig('50ms-stack-latencies-combined-PARTIAL.png')
  elif (s == 1):
    plt.axis([0, 300, 100, 125])
    plt.savefig('100ms-stack-latencies-combined-PARTIAL.png')
  elif (s == 2):
    plt.axis([0, 300, 150, 175])
    plt.savefig('150ms-stack-latencies-combined-PARTIAL.png')
