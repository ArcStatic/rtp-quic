...
client_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_001L_216000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_01L_216000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_1L_216000F_2000D_60R_client.txt"]


server_files_50 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_001L_216000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_01L_216000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/50ms/RELIABLE_3B_1L_216000F_2000D_60R_server.txt"]

client_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_001L_216000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_01L_216000F_2000D_60R_client.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_1L_216000F_2000D_60R_client.txt"]


server_files_100 = ["/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_001L_216000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_01L_216000F_2000D_60R_server.txt", "/home/vivian/Documents/L5project/rtp-quic/revised_data/1hr/100ms/RELIABLE_3B_1L_216000F_2000D_60R_server.txt"]
...
for s in range(2):
  ...
  for a in range(len(server_files)):
    ...
    if (a == 0):
      lines.append(plt.plot(x, y, label = "0.01% loss"))
      plt.setp(lines[0], markerfacecolor='b')
    elif (a == 1):
      lines.append(plt.plot(x, y, label = "0.1% loss"))
      plt.setp(lines[1], markerfacecolor='g')
    elif (a == 2):
      lines.append(plt.plot(x, y, label = "1% loss"))
      plt.setp(lines[2], markerfacecolor='k')
    #else:
      #lines.append(plt.step(x, y))
  #ie. 5 minute playback buffer
  #y = x + latency + 300  
  #lines.append(plt.plot(x, y, label = "Playback buffer"))
  ...
  if (s == 0):
    plt.savefig('50ms-1hr-relative-offsets-combined-reliable.png')
  elif (s == 1):
    plt.savefig('100ms-1hr-relative-offsets-combined-reliable.png')
  ...
  if (s == 0):
    plt.savefig('50ms-1hr-app-latencies-combined-reliable.png')
  elif (s == 1):
    plt.savefig('100ms-1hr-app-latencies-combined-reliable.png')
  ...
  if (s == 0):
    plt.savefig('1hr-50ms-stack-latencies-combined-reliable.png')
  elif (s == 1):
    plt.savefig('1hr-100ms-stack-latencies-combined-reliable.png')
