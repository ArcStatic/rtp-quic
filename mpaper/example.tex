...
%1 stall every 1.282 seconds
%0.1 increase every 1.282 seconds
%(200/0.1) x 1.282
%200s limit
...
%This could cause problems for real-time multimedia applications: International Telecommunication Recommendation G.114 recommends no more than 150ms latency ``mouth-to-ear'' for audio communications \cite{ITU-REC}. Gaming has even stricter latency bounds
